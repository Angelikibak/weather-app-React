                  ...
                  <div className='current-temperature'>
                        ...
                        <div className='current-temperature__content-container'>
                              <div className='current-temperature__city'>
                                    <span className='current-temperature__summary'>
                                          {description}
                                    </span>
                                    <span className='current-stats__value'>
                                          {highestTemp - kelvin} &deg;/
                                          {lowestTemp - kelvin} &deg;{' '}
                                    </span>
                                    <span className='location-and-date__location'>
                                          {city}
                                    </span>
                                    <div></div>
                              </div>
